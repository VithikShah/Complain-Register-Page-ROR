...
class ComplainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complain" do
    assert_difference('Complain.count') do
      post complains_url, params: { complain: { complain: @complain.complain, subject: @complain.subject } }
    end
  ...
  test "should update complain" do
    patch complain_url(@complain), params: { complain: { complain: @complain.complain, subject: @complain.subject } }
